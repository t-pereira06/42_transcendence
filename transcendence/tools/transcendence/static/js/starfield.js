...
(function(root, factory) {
  ...
  const config = {
    ...
    baseSpeed: 1.75,                     // Base speed of stars (will affect acceleration)
    trailLength: 0.6,                 // Length of star trail (0-1)
    starColor: "rgb(255, 255, 255)",  // Color of stars (only rgb)
    canvasColor: "rgb(0, 0, 0)",      // Canvas background color (only rgb)
    hueJitter: 180,                     // Maximum hue variation in degrees (0-360)
    maxAcceleration: 2,              // Maximum acceleration
    accelerationRate: 0.2,            // Rate of acceleration
    decelerationRate: 0.2,            // Rate of deceleration
    minSpawnRadius: 0,               // Minimum spawn distance from origin
